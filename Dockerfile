...
ENV INSTALL_PATH /kidc
# The name of the application is kidc and while there
...
# having to CD into the /kidc folder every time would be
# lame, so instead we can set the WORKDIR to be /kidc.
#
...
#
# It copies it to /kidc because of the WORKDIR being set.
#
...
# /kidc folder inside of the Docker image.
#
